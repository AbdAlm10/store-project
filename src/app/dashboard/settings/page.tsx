    ...
    <div className="space-y-6">
      ...
      <section className="grid gap-3 sm:grid-cols-2">
        <Link
          ...
          className="rounded-[1.25rem] bg-white p-5 shadow-[0_8px_30px_-18px_rgba(15,23,42,0.18)] transition hover:-translate-y-0.5"
        >
        ...
        <div className="rounded-[1.25rem] bg-white p-5 shadow-[0_8px_30px_-18px_rgba(15,23,42,0.18)]">
